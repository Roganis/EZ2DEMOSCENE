...
- **Presets + layers for beginners.**
  ...
  - **Sprites**: billboards, upright or fixed image planes with alpha,
    ...
    sparkle sheets).
  - **Big swarms**: up to 250,000 copies in orbits, a cloud, a shell or a
    spiral galaxy, generated by a compute shader on desktop and WebGPU
    (the CPU fallback on WebGL2 draws the same picture).
